 ...
 * <p>
 * En términos del patrón <strong>Strategy</strong>, esta clase es una
 * estrategia concreta que
...
public class Consola implements GameIO {
     ...
     * No lo cerramos explícitamente para no clausurar la entrada estándar de la
     * JVM.
     */
    private final Scanner scanner = new Scanner(System.in);

    /**
     * Crea la estrategia de consola inicializando el {@link Scanner} asociado a la
     * entrada estándar.
     */
    public Consola() {
        // El scanner ya está preparado en el campo final; no se requiere lógica
        // adicional.
    }
